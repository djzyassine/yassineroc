...
$num= $_GET['num'];
echo '<div><h5><a class="lien_majoration" style="padding:20px 10px 20px 10px;background-color:#444;font-size:15px;border-bottom:1px solid #ddd;" href="heure_supplimentaire.php?num='.$num.'">Ajouter Des Heures Suppl&eacute;mentaires</a></h5></div>';
echo '<div><h5><a class="lien_majoration" style="padding:20px 10px 20px 10px;background-color:#444;font-size:15px;border-bottom:1px solid #ddd;"href="indemnite.php?num='.$num.'">Ajouter Des Indemnités Imposables</a></h5></div>';
echo '<div><h5><a class="lien_majoration" style="padding:20px 10px 20px 10px;background-color:#444;font-size:15px;border-bottom:1px solid #ddd;" href="prime.php?num='.$num.'">Ajouter Des Primes Imposables</a></h5></div>';
?>
