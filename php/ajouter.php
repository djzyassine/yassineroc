...
<!--<div class="wrapper" >-->
			...
			<!--<div class="content">-->
				<div id="form_wrapper" class="form_wrapper">
					...
					<form class="login active" method="post" action="ajouter1.php">
					



  <table width="600px" class="modifier" style=" text-align:center;" align="left" cellspacing="55px" cellspacing="80"><tr>
  <td width="114px" align="center" height="50"><input type="hidden" name="num"><h5>Nom:</h5></td>
  <td width="114px"><input type="text" name="nom"></td></tr><tr>

  <td height="50%"><h5>Prenom:</h5></td>
  <td><input type="text" name="prenom"></td></tr><tr>
  <td height="50"><h5>Cin:</h5></td><td><input type="text" name="cin"></td></tr>
  <tr><td height="50"><h5>Sex:</h5></td>
  <td height="50"><input type="radio" name="sex" value="H" >   
  Homme  
  <label for="radio"><input type="radio" name="sex"  value="F">    
  Femme </label></td></tr><tr>
  <td height="50"><h5>Date Naissance:</h5></td>

  <td><input type="date" name="date_n" id="date" style="border: solid 1px #E5E5E5;background: #FFFFFF;margin: 5px 30px 0px 30px;padding: 9px;display:block;font-size:16px;width:76%;background: -webkit-gradient(linear,left top,left 25,from(#FFFFFF),color-stop(4%, #EEEEEE),to(#FFFFFF));background: -moz-linear-gradient(top,#FFFFFF,#EEEEEE 1px,#FFFFFF 25px);-moz-box-shadow: 0px 0px 8px #f0f0f0;-webkit-box-shadow: 0px 0px 8px #f0f0f0;box-shadow: 0px 0px 8px #f0f0f0;"></td>
  </tr><tr><td height="50"><h5>Tel:</h5></td><td><input type="text" name="tel"></td></tr>
  <tr><td height="50"><h5>Date d\'embauche</h5></td>
  <td><input type="date" style="border: solid 1px #E5E5E5;background: #FFFFFF;margin: 5px 30px 0px 30px;padding: 9px;display:block;font-size:16px;width:76%;background: -webkit-gradient(linear,left top,left 25,from(#FFFFFF),color-stop(4%, #EEEEEE),to(#FFFFFF));background: -moz-linear-gradient(top,#FFFFFF,#EEEEEE 1px,#FFFFFF 25px);-moz-box-shadow: 0px 0px 8px #f0f0f0;-webkit-box-shadow: 0px 0px 8px #f0f0f0;box-shadow: 0px 0px 8px #f0f0f0;" name="date_e"></td></tr>
  <tr><td height="50"><h5>Situation Familiale:</h5></td>
  <td><input type="radio" name="situation_fam" value="C" >   
  C&eacute;libataire  
  <label for="radio"><input type="radio" name="situation_fam" value="M">
  Marier</label></td></tr>   
  <tr><td height="50" ><h5>Nembre d\'anfant:</h5></td>
  <td><input type="number" name="nbr_enfant" style="border: solid 1px #E5E5E5;background: #FFFFFF;margin: 5px 30px 0px 30px;padding: 9px;display:block;font-size:16px;width:76%;background: -webkit-gradient(linear,left top,left 25,from(#FFFFFF),color-stop(4%, #EEEEEE),to(#FFFFFF));background: -moz-linear-gradient(top,#FFFFFF,#EEEEEE 1px,#FFFFFF 25px);-moz-box-shadow: 0px 0px 8px #f0f0f0;-webkit-box-shadow: 0px 0px 8px #f0f0f0;box-shadow: 0px 0px 8px #f0f0f0;" value="'.$rows[9].'"></td></tr><tr>
  <td height="50"><h5>Salaire de base:</h5></td><td><input type="text" name="sb"></td>
