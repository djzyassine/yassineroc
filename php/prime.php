...
<!--<div class="wrapper" >-->
			...
			<!--<div class="content">-->
				<div id="form_wrapper" style="box-shadow:0px 0px 0px; border:0px" class="form_wrapper">
					...
					<form class="login active" method="post" action="prime_ajoute.php">
  ...
  echo '<input type="hidden" name="num" value="'.$nom.'"><h5>Prime D’Outillage:</h5></td>';
  ?>
  <td width="114px"><input type="text" name="h25" ></td>
</tr>
  <tr><td height="50%"><h5>Prime De Salissure  :</h5></td>
  <td width="114px"><input type="text" name="h50" ></td></tr>
  <tr>
  <td height="50"><h5>Autres:</h5></td><td width="114px"><input type="text" name="h100" ></td></tr>
