...
<!--<div class="wrapper" >-->
			...
			<!--<div class="content">-->
				<div id="form_wrapper" style="box-shadow:0px 0px 0px; border:0px" class="form_wrapper">
					...
					<form class="login active" method="post" action="heure_supplimentaire_ajoute.php">
  ...
  echo '<input type="hidden" name="num" value="'.$nom.'"><h5>Heures Suppl&eacute;mentaires à 25%:</h5></td>';
  ?>
  <td width="114px"><input type="number" name="h25" style="border: solid 1px #E5E5E5;background: #FFFFFF;margin: 5px 30px 0px 30px;padding: 9px;display:block;font-size:16px;width:76%;background: -webkit-gradient(linear,left top,left 25,from(#FFFFFF),color-stop(4%, #EEEEEE),to(#FFFFFF));background: -moz-linear-gradient(top,#FFFFFF,#EEEEEE 1px,#FFFFFF 25px);-moz-box-shadow: 0px 0px 8px #f0f0f0;-webkit-box-shadow: 0px 0px 8px #f0f0f0;box-shadow: 0px 0px 8px #f0f0f0;"></td>
</tr>
  <tr><td height="50%"><h5>Heures Suppl&eacute;mentaires à 50%:</h5></td>
  <td width="114px"><input type="number" name="h50" style="border: solid 1px #E5E5E5;background: #FFFFFF;margin: 5px 30px 0px 30px;padding: 9px;display:block;font-size:16px;width:76%;background: -webkit-gradient(linear,left top,left 25,from(#FFFFFF),color-stop(4%, #EEEEEE),to(#FFFFFF));background: -moz-linear-gradient(top,#FFFFFF,#EEEEEE 1px,#FFFFFF 25px);-moz-box-shadow: 0px 0px 8px #f0f0f0;-webkit-box-shadow: 0px 0px 8px #f0f0f0;box-shadow: 0px 0px 8px #f0f0f0;"></td></tr>
  <tr>
  <td height="50"><h5>Heures Suppl&eacute;mentaires à 100%:</h5></td><td width="114px"><input type="number" name="h100" style="border: solid 1px #E5E5E5;background: #FFFFFF;margin: 5px 30px 0px 30px;padding: 9px;display:block;font-size:16px;width:76%;background: -webkit-gradient(linear,left top,left 25,from(#FFFFFF),color-stop(4%, #EEEEEE),to(#FFFFFF));background: -moz-linear-gradient(top,#FFFFFF,#EEEEEE 1px,#FFFFFF 25px);-moz-box-shadow: 0px 0px 8px #f0f0f0;-webkit-box-shadow: 0px 0px 8px #f0f0f0;box-shadow: 0px 0px 8px #f0f0f0;"></td></tr>
