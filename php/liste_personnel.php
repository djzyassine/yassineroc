...
echo '<td colspan="2" width="60" style="vertical-align:central;" ><a href="http://localhost:8080/oc/php/ajouter.php"><img class="ajouter" src="../images/icons/Actions-list-add-user.ico" border="0" alt="" width="60" height="60" /></a></td>';
...
echo '<td width="140" class="ligne"><a href="majoration.php?num='.$rows[0].'">'.$rows[1].'</td>';
...
echo '<td width="140" class="ligne">'.$rows[10].'</td>';

echo '<td width=30><span style="line-height: 1.3em;"><a href="Modifier.php?num='.$rows[0].'"><img src="../images/icons/Gear.ico"   width="30" height="30" /></a></span></td>';

echo '<td width=30><span style="line-height: 1.3em;"><a href="supprimer.php?num='.$rows[0].'"><img src="../images/icons/corbeille-vide.ico"   width="30" height="30" /></a></span></td>';
