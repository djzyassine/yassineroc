...
$query=mysql_query('select * from personnel');
  ...
  echo '<h5>Nom et Pr&eacute;nom:</h5></td>';
   echo '<td width="114px"><input type="text" name="nom" value="'.$rows[1].' '.$rows[2].'" ></td>';
echo '</tr>';
  echo '<tr><td height="50%"><h5>Situation De Famille:</h5></td>';
  echo '<td width="114px"><input type="text" name="h50" value="'.$rows[8].'" ></td></tr>';
  echo '<tr>';
  echo '<td height="50"><h5>Nombre d\'enfants:</h5></td><td width="114px"><input type="text" name="h100" value="'.$rows[9].'"></td></tr>';
  echo '<td height="50"><h5>Nombre de d&eacute;duction:</h5></td><td width="114px"><input type="text" name="mutuelle" value="'.$rows[3].'"></td></tr>';
    echo '<td width="114px" height="50">';
  echo '<h5>Detail De Paie:</h5></td>';
   echo '<td width="114px"><input type="text" name="h25" value="'.$rows[0].'" ></td>';
echo '</tr>';
  echo '<tr><td height="50%"><h5>Salaire De Base:</h5></td>';
  echo '<td width="114px"><input type="text" name="h50" value="'.$rows[1].'" ></td></tr>';
  echo '<tr>';
  echo '<td height="50"><h5>Heures Suppl&eacute;mentaires à 25%:</h5></td><td width="114px"><input type="text" name="h100" value="'.$rows[2].'"></td></tr>';
  echo '<td height="50"><h5>Heures Suppl&eacute;mentaires à 50%:</h5></td><td width="114px"><input type="text" name="mutuelle" value="'.$rows[3].'"></td></tr>';
    echo '<td width="114px" height="50">';
  echo '<h5>Heures Suppl&eacute;mentaires à 100%:</h5></td>';
   echo '<td width="114px"><input type="text" name="h25" value="'.$rows[0].'" ></td>';
echo '</tr>';
  echo '<tr><td height="50%"><h5>Prime D\'anciennet&eacute;:</h5></td>';
  echo '<td width="114px"><input type="text" name="h50" value="'.$rows[1].'" ></td></tr>';
  echo '<tr>';
  echo '<td height="50"><h5>Total Prime Imposable:</h5></td><td width="114px"><input type="text" name="h100" value="'.$rows[2].'"></td></tr>';
  echo '<td height="50"><h5>Total Indemnit&eacute;:</h5></td><td width="114px"><input type="text" name="mutuelle" value="'.$rows[3].'"></td></tr>';
    echo '<td width="114px" height="50">';
  echo '<h5>Salaire Brut:</h5></td>';
   echo '<td width="114px"><input type="text" name="h25" value="'.$rows[0].'" ></td>';
echo '</tr>';
  echo '<tr><td height="50%"><h5>Salaire Brute Imposable:</h5></td>';
  echo '<td width="114px"><input type="text" name="h50" value="'.$rows[1].'" ></td></tr>';
  echo '<tr>';
  echo '<td height="50"><h5>Frais Professionnels:</h5></td><td width="114px"><input type="text" name="h100" value="'.$rows[2].'"></td></tr>';
  echo '<td height="50"><h5>Cotisation CNSS:</h5></td><td width="114px"><input type="text" name="mutuelle" value="'.$rows[3].'"></td></tr>';
    echo '<td width="114px" height="50">';
  echo '<h5>Cotisation AMO:</h5></td>';
   echo '<td width="114px"><input type="text" name="h25" value="'.$rows[0].'" ></td>';
echo '</tr>';
  echo '<tr><td height="50%"><h5>Cotisation Retraite:</h5></td>';
  echo '<td width="114px"><input type="text" name="h50" value="'.$rows[1].'" ></td></tr>';
  echo '<tr>';
  echo '<td height="50"><h5>Cotisation Mutuelle:</h5></td><td width="114px"><input type="text" name="h100" value="'.$rows[2].'"></td></tr>';
  echo '<td height="50"><h5>Total:</h5></td><td width="114px"><input type="text" name="mutuelle" value="'.$rows[3].'"></td></tr>';
    echo '<td width="114px" height="50">';
  echo '<h5>Salaire Imposable Net:</h5></td>';
   echo '<td width="114px"><input type="text" name="h25" value="'.$rows[0].'" ></td>';
echo '</tr>';
  echo '<tr><td height="50%"><h5>Taux IR:</h5></td>';
  echo '<td width="114px"><input type="text" name="h50" value="'.$rows[1].'" ></td></tr>';
  echo '<tr>';
  echo '<td height="50"><h5>Somme à d&eacute;duire:</h5></td><td width="114px"><input type="text" name="h100" value="'.$rows[2].'"></td></tr>';
  echo '<td height="50"><h5>IR Brute:</h5></td><td width="114px"><input type="text" name="mutuelle" value="'.$rows[3].'"></td></tr>';
    echo '<tr><td height="50%"><h5>Charge De Famille:</h5></td>';
  echo '<td width="114px"><input type="text" name="h50" value="'.$rows[1].'" ></td></tr>';
  echo '<tr>';
  echo '<td height="50"><h5>IR Net:</h5></td><td width="114px"><input type="text" name="h100" value="'.$rows[2].'"></td></tr>';
  echo '<td height="50"><h5>Salaire Net à Payer:</h5></td><td width="114px"><input type="text" name="mutuelle" value="'.$rows[3].'"></td></tr>';
  }
  ?>
